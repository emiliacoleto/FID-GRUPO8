...
# Se muestran los 20 itemsets más frecuentes formados por más de dos items.
inspect(sort(itemsets[size(itemsets) > 2], decreasing = TRUE)[1:20])

# Se muestran los 20 itemsets más frecuentes formados por más de tres items.
inspect(sort(itemsets[size(itemsets) > 3], decreasing = TRUE)[1:20])

# Se muestran los 20 itemsets más frecuentes formados por más de cuatro items.
inspect(sort(itemsets[size(itemsets) > 4], decreasing = TRUE)[1:20])

...
También se proporciona una manera mas gráfica de verlo usando la función kmeans para calcular las similitudes con la distancia anteriormente calculada y pintándolo en una matriz de clusteres.

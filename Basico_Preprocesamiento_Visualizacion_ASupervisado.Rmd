...
```{r Preprocesamiento 1: Detección y eliminación de outliers}
...
```{r Preprocesamiento 1: Detección y eliminación de outliers: Atributo RestingBP}
...
```{r Preprocesamiento 1: Detección y eliminación de outliers: Atributo Cholesterol}
...
```{r Preprocesamiento 1: Detección y eliminación de outliers: Atributo MaxHR}
...
```{r Preprocesamiento 1: Detección y eliminación de outliers: Atributo OldPeak. FIN de Preprocesamiento 1}
